    ...
    <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
      <div className="mb-16 text-center">
        ...
        <p className="text-xl text-muted-foreground">
          Streamline your compliance workflows with AI-powered requirements
          extraction and assessment tracking
        </p>
      </div>
      ...
      <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
        <Card className="flex flex-col p-6">
          ...
          <p className="mb-4 flex-1 text-sm text-muted-foreground">
            Upload compliance documents as PDFs and automatically extract
        ...
        <Card className="flex flex-col p-6">
          ...
          <p className="mb-4 flex-1 text-sm text-muted-foreground">
            Create and manage assessments based on templates, tracking
            compliance status
          </p>
        ...
        <Card className="flex flex-col p-6">
          ...
          <p className="mb-4 flex-1 text-sm text-muted-foreground">
            Real-time progress tracking and submission review with detailed
            reporting
          </p>
